...
set ::env(DESIGN_NAME) scan_wrapper_341922299323089492
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341922299323089492.v \
$::env(DESIGN_DIR)/scan_wrapper_341922299323089492.v"
